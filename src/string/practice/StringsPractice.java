...
public class StringsPractice {
	...
	public static void main(String[] args) {
		...
		// following two prints are to get the Unicode value of non-matching characters on 2nd place
		...
		System.out.println(105-67); // this is verify the calculation for above example
